 ...
 * description:
 *****************************************************/
public class DefaultHeader extends FrameLayout implements UIHandler {

    private final static String KEY_SharedPreferences = "refresh_header_last_update";
    ...
    protected void initViews(AttributeSet attrs) {
        ...
        mTitleTextView = (TextView) header.findViewById(R.id.header_title);
        mLastUpdateTextView = (TextView) header.findViewById(R.id.header_last_update);
...
//        mLastUpdateTime=new Date().getTime();
    ...
    private void tryUpdateLastUpdateTime() {
        if (TextUtils.isEmpty(mLastUpdateTimeKey) || !mShouldShowLastUpdate) {
            ...
            if (TextUtils.isEmpty(time)) {
                mLastUpdateTextView.setVisibility(GONE);
               // mLastUpdateTextView.setText("2018");
            } else {
    ...
    private void crossRotateLineFromTopUnderTouch(BaseRefreshView frame) {
        if (!frame.isPullToRefresh()) {
            mTitleTextView.setVisibility(VISIBLE);
    ...
    private void crossRotateLineFromBottomUnderTouch(BaseRefreshView frame) {
        mTitleTextView.setVisibility(VISIBLE);
        if (frame.isPullToRefresh()) {
            mTitleTextView.setText(getResources().getString(R.string.pull_down_to_refresh));
        } else {
